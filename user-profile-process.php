<?php
      ...
      //This file is for the insertion of data in profiles
...
$pname=$_FILES["ppic"]["name"];       //here we are extracting the permanent name data of pic uploaded from our front end
$ptempname=$_FILES["ppic"]["tmp_name"];       //here we are extracting temp name data of pic that have been uploaded from our front end
$query="insert into profiles values('$userid','$username','$usergender','$contact','$stay','$location','$zipcode','$useremail','$identity','$dob','$pname')";
move_uploaded_file($ptempname,"uploads/".$pname);   //moving upload  file to our folder;
...
if($errmsg=="")
{
    echo "<script> alert('Updated Successfully'); document.location='user-dashboard.php'</script>";
}
else{
    echo "$errmsg";
}
